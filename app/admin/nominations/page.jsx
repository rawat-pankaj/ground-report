...
export default function NominationsPage() {
  ...
  return (
    <div>
      ...
      <h1 style={{ fontSize: "18px", fontWeight: 700, color: "var(--ink)", fontFamily: "'Archivo Narrow', sans-serif", textTransform: "uppercase", letterSpacing: "0.02em", marginBottom: "16px" }}>Suggested Videos ({pending.length} pending)</h1>
